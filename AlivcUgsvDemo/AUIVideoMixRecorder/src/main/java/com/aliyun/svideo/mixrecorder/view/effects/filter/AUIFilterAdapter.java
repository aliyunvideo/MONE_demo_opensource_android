...
public class AUIFilterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.ugsv_mixrecorder_chooser_filter_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (path == null || "".equals(path)) {
            name = mContext.getString(R.string.ugsv_mixrecorder_panel_effect_none);
            filterViewHolder.mImage.setImageResource(R.mipmap.ic_ugsv_recorder_chooser_clear);
        } else {
