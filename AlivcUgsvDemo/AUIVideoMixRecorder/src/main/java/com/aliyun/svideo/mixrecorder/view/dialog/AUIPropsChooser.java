...
import com.aliyun.svideo.mixrecorder.view.effects.paster.AUIPasterChooseView;
...
public class AUIPropsChooser extends AUIBaseChooser {
    ...
    public List<Fragment> createPagerFragmentList() {
        ...
        //贴纸
        pasterChooseView.setTabTitle(getResources().getString(R.string.ugsv_mix_recorder_control_props));
