...
public class AUIRecordProgressView extends AVCircleProgressView {
    ...
    public AUIRecordProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AUIRecordProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
