 ...
 * 录制参数配置
 */
public class AUIRecorderInputParam {
    /**
     ...
     */
    private AUIVideoDisplayParam mRecordDisplayParam;
    /**
     * 主要用于调整合拍功能中导入视频在视频中的布局；普通录制不需要额外设置
     */
    private AUIVideoDisplayParam mPlayDisplayParam;
    ...
    public AUIVideoDisplayParam getRecordDisplayParam() {
        return mRecordDisplayParam;
    }
    public AUIVideoDisplayParam getPlayDisplayParam() {
        return mPlayDisplayParam;
    }

    public void setRecordDisplayParam(AUIVideoDisplayParam mRecordDisplayParam) {
        this.mRecordDisplayParam = mRecordDisplayParam;
    }

    public void setPlayDisplayParam(AUIVideoDisplayParam mPlayDisplayParam) {
        this.mPlayDisplayParam = mPlayDisplayParam;
    }

    public static class Builder {
        private AUIRecorderInputParam mParam = new AUIRecorderInputParam();
        ...
        public Builder setRecordDisplayParam(AUIVideoDisplayParam mRecordDisplayParam) {
            this.mParam.mRecordDisplayParam = mRecordDisplayParam;
            return this;
        }

        public Builder setPlayDisplayParam(AUIVideoDisplayParam mPlayDisplayParam) {
        ...
        public AUIRecorderInputParam build() {
            return this.mParam;
        }
    }
}
