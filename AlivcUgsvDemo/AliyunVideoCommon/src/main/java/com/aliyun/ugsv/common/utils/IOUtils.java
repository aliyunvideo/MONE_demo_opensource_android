...
import com.aliyun.ugsv.common.stream.ByteArrayOutputStream;
import com.aliyun.ugsv.common.stream.StringBuilderWriter;
import com.aliyun.vod.common.utils.Charsets;
import com.aliyun.vod.common.utils.StringCodingUtils;
...
public class IOUtils {
    ...
    public static boolean copyStream(InputStream is, RandomAccessFile os, CopyListener listener, int alreadyRead) throws IOException {
        return copyStream(is, os, listener, alreadyRead, DEFAULT_BUFFER_SIZE);
    }

    public static boolean copyStream(InputStream is, RandomAccessFile os, CopyListener listener, int alreadyRead, int bufferSize)
    throws IOException {
        int current = alreadyRead;
