...
package com.aliyun.ugsv.common.qupaiokhttp.https;
...
public class HttpsCerManager {
    ...
    private class OkHttpTrustManager implements X509TrustManager {
        ...
        public void checkClientTrusted(X509Certificate[] chain, String authType) throws CertificateException {
            throw new CertificateException("This OkHttp only for client, not for sever");
        }
        ...
        public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
            try {
                ...
                try {
                    ...
                    Log.e(HttpsCerManager.class.getName(), "Https certificate is invalid");
                    throw e;
                }
            }
        }
