package com.aliyun.ugsv.common.base;
...
import com.aliyun.ugsv.common.baseAdapter.BaseQuickAdapter;
import com.aliyun.ugsv.common.baseAdapter.BaseViewHolder;
import com.aliyun.ugsv.common.baseAdapter.BaseQuickAdapter.OnItemClickListener;
...
public class AlivcListSelectorDialogFragment extends BaseDialogFragment {
    ...
    private void initData() {
        if (mLists != null) {
            ...
            mSelectorQuickAdapter.setOnItemClickListener(new OnItemClickListener() {
                @Override
