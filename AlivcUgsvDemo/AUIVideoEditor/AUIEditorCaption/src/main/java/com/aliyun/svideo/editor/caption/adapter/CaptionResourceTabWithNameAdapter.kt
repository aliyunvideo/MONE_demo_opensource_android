...
import com.aliyun.svideo.editor.caption.databinding.CaptionEditPanelResourceItemWithNameBinding
...
class CaptionResourceTabWithNameAdapter(private val context : Context) :
    RecyclerAdapter<CaptionResource, CaptionEditPanelResourceItemWithNameBinding>(context) ,
    ...
    override fun getLayoutId(viewType: Int): Int {
        return R.layout.caption_edit_panel_resource_item_with_name
    }
    ...
    override fun onViewCreated(binding: CaptionEditPanelResourceItemWithNameBinding, viewType: Int) {
    ...
    override fun onBindItem(binding: CaptionEditPanelResourceItemWithNameBinding?, data: CaptionResource, position: Int) {
