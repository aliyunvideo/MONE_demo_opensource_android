...
class FileDownloaderDBCipherOpenHelper extends SQLiteOpenHelper {
    final static String DATABASE_NAME = "filedownloaderfinal_cipher.db";
    final Map<String, String> mDbExtFieldMap;
    private DbUpgradeListener mDbUpgradeListener;


    public FileDownloaderDBCipherOpenHelper(Context context, final int dbVersion,
...
//        allFieldMap.put(FileDownloaderModel.TYPE, "INTEGER");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (mDbUpgradeListener != null) {
            mDbUpgradeListener.onCipherUpgrade(db, oldVersion, newVersion);
        }
    }
