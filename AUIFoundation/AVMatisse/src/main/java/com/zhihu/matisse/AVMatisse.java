...
import com.zhihu.matisse.ui.AVMatisseActivity;
 ...
 */
public final class AVMatisse {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private AVMatisse(Activity activity) {
        this(activity, null);
    }

    private AVMatisse(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private AVMatisse(Activity activity, Fragment fragment) {
     ...
     */
    public static AVMatisse from(Activity activity) {
        return new AVMatisse(activity);
    }
     ...
     * @return Matisse instance.
     */
    public static AVMatisse from(Fragment fragment) {
        return new AVMatisse(fragment);
    }
    ...
    public static List<Uri> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(AVMatisseActivity.EXTRA_RESULT_SELECTION);
    }
    ...
    public static List<String> obtainPathResult(Intent data) {
        return data.getStringArrayListExtra(AVMatisseActivity.EXTRA_RESULT_SELECTION_PATH);
    }
    ...
    public static boolean obtainOriginalState(Intent data) {
        return data.getBooleanExtra(AVMatisseActivity.EXTRA_RESULT_ORIGINAL_ENABLE, false);
    }
