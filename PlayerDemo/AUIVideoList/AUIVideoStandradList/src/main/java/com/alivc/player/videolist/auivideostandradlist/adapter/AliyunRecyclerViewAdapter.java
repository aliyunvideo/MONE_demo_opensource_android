...
public class AliyunRecyclerViewAdapter extends RecyclerView.Adapter<AliyunRecyclerViewAdapter.MyViewHolder> {
    ...
    private  List<VideoInfo> mVideoListBeanItems;
...
//        }).into(iv);
    ...
    public void setData( List<VideoInfo> videoListBeanItems) {
        this.mVideoListBeanItems = videoListBeanItems;
    }

    public void addMoreData(List<VideoInfo> videoListBeanItems) {
